...
public class BeamActivity extends Activity {
	...
	protected void onResume() {
		...
		// AAR 전송 테스트 
//		NdefMessage aarMsg = makeNdefAARMessage("edu.jaen.nfc.beam");
//		mNfcAdapter.setNdefPushMessage(aarMsg, this);		
	...
	public NdefMessage makeNdefAARMessage(String packageName) {
